...
function renderDay(dayId) {
    ...
    // Ruta de transporte (si tiene detalles de rutas en carro)
...
function createTransportCard(transport) {
    ...
    if (transport.note) {
        details += `<br><small style="color: var(--alpine-gold);">⚠️ ${transport.note}</small>`;
    }
    ...
    if (transport.carReturn) {
        details += `<br><strong>⚠️ ${transport.carReturn}</strong>`;
    }
